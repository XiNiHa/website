...
const Item: Component<Props> = ({ experience, subprojectMap }) => {
  ...
  return (
    ...
    >
      <div
        class="flex items-stretch gap-2 cursor-pointer w-fit mb-1 transition-colors duration-300 border-b border-b-transparent hover:border-b-gray-400 sm:flex-nowrap"
          ...
          <Show when={experience.githubUrl}>
            ...
            >
              <SmoothIcon
                ...
                iconAlt="Github Icon"
                class="w-5 h-5 md:w-6 md:h-6 mx-2 inline-block"
              />
            </a>
          </Show>
        </h3>
